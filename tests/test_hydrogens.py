...
class TestComputeHydrogen:
    ...
    @pytest.mark.parametrize('data',[
        (Data(np.array([26.87, 45.09, 26.03], dtype=np.float32),
              ...
              np.array([26.6186898, 44.1429609, 25.552450], dtype=np.float32))),
        (Data(np.array([09.37, 46.61, 21.07], dtype=np.float32),
              ...
              np.array([10.2773790, 46.049350, 20.8454230], dtype=np.float32))),
        (Data(np.array([30.83, 37.09, 27.29], dtype=np.float32),
              ...
              np.array([31.3003390, 36.458860, 28.0440180], dtype=np.float32))),
        (Data(np.array([40.79, 32.48, 25.71], dtype=np.float32),
              ...
              np.array([40.6256700, 33.5420680, 25.8919559], dtype=np.float32))),
    ])
